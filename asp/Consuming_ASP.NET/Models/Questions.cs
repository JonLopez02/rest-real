...
namespace Consuming_ASP.NET.Models
{
    public class Questions
    {
        ...
        public static int actualScore { get; set; }
        ...
        public Questions(string category, string type, string difficulty, string question, string correct_answer, string[] incorrect_answers, bool available, int score)
        {
            this.category = category;
            this.type = type;
            this.difficulty = difficulty;
